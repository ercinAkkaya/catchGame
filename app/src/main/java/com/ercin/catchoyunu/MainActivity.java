...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timeText = (TextView) findViewById(R.id.txtSayac);
        scoreText = (TextView) findViewById(R.id.txtSkor);
        ...
        imageView5, imageView6, imageView7, imageView8, imageView9,imageView10,imageView11,imageView12};
